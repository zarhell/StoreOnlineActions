...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvProductName,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((ConstraintLayout) rootView, tvProductName, tvProductPrice);
    }
